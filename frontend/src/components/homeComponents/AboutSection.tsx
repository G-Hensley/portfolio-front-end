        ...
        <section id="about-section" className='flex flex-col gap-12 items-center min-h-screen w-full p-8 md:px-16 relative z-10'>
            ...
            <div id="information-grid">
                ...
                <div id="personal-story" className="info-container">
                    <h3 className='info-title font-body-ff relative text-mobile-lg-body md:text-desktop-lg-body'>Personal Story</h3>
                ...
                <div id="education" className="info-container">
                    <h3 className='info-title font-body-ff relative text-mobile-lg-body md:text-desktop-lg-body'>Education</h3>
                    <p className='info-text font-body-ff text-mobile-body md:text-desktop-body'>
                ...
                <div id="hobbies" className="info-container">
                    <h3 className='info-title font-body-ff relative text-mobile-lg-body md:text-desktop-lg-body'>Hobbies</h3>
                ...
                <div id="future" className="info-container">
                    <h3 className='info-title font-body-ff relative text-mobile-lg-body md:text-desktop-lg-body'>Future Goals</h3>
                ...
                <div id="why" className="info-container">
                    <h3 className='info-title font-body-ff relative text-mobile-lg-body md:text-desktop-lg-body'>Why Web Development?</h3>
