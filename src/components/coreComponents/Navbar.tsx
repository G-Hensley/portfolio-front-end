  ...
  return (
    <nav
      ...
      <ul
        ...
        className={`nav-list absolute flex flex-col gap-12 border-[1.5px] border-t-0 border-primary-magenta-700 bg-linear-300 from-charcoal/70 via-secondary-blue-500/70 to-charcoal/70
